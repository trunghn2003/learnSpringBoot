...
public class UserControllerTest {
    ...
    void createUser_validRequest_sucess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("1adssda"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.username").value("trungviet"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.firstName").value("Trung"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.lastName").value("Viet"))
